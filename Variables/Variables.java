...
class Variables {
  public static void main(String args[]) {
    int miles = 0; // (data type int) (variable miles) (assignment operator =) (value 0)
                   // (semicolon)
    double kilometers = 0.0d; // (data type double) (variable kilometers) (assignment operator =) (value 0.0)
                              // (semicolon)
    ...
    distance = miles * kilometers; // multiply variable values using the multiplication operator (*) and store the
                                   // value to the distance variable
